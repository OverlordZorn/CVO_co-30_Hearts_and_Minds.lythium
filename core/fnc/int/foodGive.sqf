...
private _hadFood = "ACE_Humanitarian_Ration" in items _target;
if (
    [player, "ACE_Humanitarian_Ration"] call CBA_fnc_removeItem &&
    {[_target, "ACE_Humanitarian_Ration", true] call CBA_fnc_addItem}
) then {
